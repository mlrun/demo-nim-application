    ...
    * `Chain` (TBD) - Expose an entire `langchain` object as a pickled model logged to MLRun.
    ...
    def __init__(
        ...
        **kwargs,
        ...
        self.model_name = self.init_kwargs.get("model_name")
    ...
    def load(self):
        ...
        loads the model.
        """
        project = mlrun.get_or_create_project(self.project, "./")
        self.model = project.get_function("my-nim-5")
        ...
        # if "." in self.llm:
        #     module, llm_class = self.llm.rsplit(".", 1)
        #     module = importlib.import_module(module)
        #     self.model = getattr(module, llm_class)
        # else:
    ...
    def predict(
        ...
        return self.model.invoke(path="/v1/chat/completions", body=body, method="POST")
