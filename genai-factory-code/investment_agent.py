...
class InvestmentAgent(ChainRunner):
    ...
    def _get_agent(self):
        ...
        data_retriever_tool = create_retriever_tool(
            ...
            "investment-policy-data-retriever",
            "Query a retriever to get information about the bank's investment policies.",
        )
...
TOOL_PROMPT = str(
    "You are a helpful AI banking assistant that can provide information about the banks investment policies and answer investment related questions. "
    "Try to answer the question using the data retriever, if the query is related to bank investment policy, "
